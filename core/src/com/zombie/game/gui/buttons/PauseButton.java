...
package com.zombie.game.gui.buttons;
...
public class PauseButton extends TextButton {
	...
	public PauseButton(Actor cover, Skin skin) {
		super(PAUSE, skin.get(TextButtonStyle.class));
		initialize(cover);
	}
	...
	public PauseButton(Actor cover, Skin skin, String styleName) {
		super(PAUSE, skin.get(styleName, TextButtonStyle.class));
		initialize(cover);
	}
